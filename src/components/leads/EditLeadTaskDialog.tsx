...
import { useUpdateLeadTask, useDeleteLeadTask, TASK_STATUSES, TASK_PRIORITIES, LeadTask } from "@/hooks/useLeadTasks";
...
export function EditLeadTaskDialog({ open, onOpenChange, task, leadCompanyName, linkedPartnerId }: Props) {
