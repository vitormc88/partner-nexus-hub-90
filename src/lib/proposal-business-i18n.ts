...
const EN: BusinessStrings = {
  ...
  keepItLicenseAmount: "KeepIT software / license",
  useItAnnualLicenseAmount: "UseIT annual software / license",
  satAnnual: "Support & Technical Assistance (S&AT) — annual",
  satIncluded: "S&AT — included (€0)",
...
const PT: BusinessStrings = {
  ...
  keepItLicenseAmount: "Software / licença KeepIT",
  useItAnnualLicenseAmount: "Software / licença anual UseIT",
  satAnnual: "Suporte & Assistência Técnica (S&AT) — anual",
  satIncluded: "S&AT — incluído (€0)",
...
const ES: BusinessStrings = {
  ...
  keepItLicenseAmount: "Software / licencia KeepIT",
  useItAnnualLicenseAmount: "Software / licencia anual UseIT",
  satAnnual: "Soporte y Asistencia Técnica (S&AT) — anual",
  satIncluded: "S&AT — incluido (€0)",
